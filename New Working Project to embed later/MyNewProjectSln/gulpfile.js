...
gulp.task('localBuild', gulpSequence(
    'cleanlocal',
    ['buildhtmlPartLoader', 'buildTheRest'] //'bundlejslocal',
));

gulp.task('spBuild', gulpSequence(
    'cleanspbuild',
    'cleanspmodule',
    [ 'buildhtmlsp','buildhtmlsp2','buildhtmlsp3'],  //'buildcsssp', 'buildjssp', 'buildimgsp',
    ['packageXmlFiles'],
...
gulp.task('buildhtmlsp2', function () {
    return gulp.src(['./WebComponents/src/webpart/**', '!./**/webpartcontent.htm'])
        .pipe(gulp.dest('./WebComponents/buildSP/webpart'));
});
gulp.task('buildhtmlsp3', function () {
    return gulp.src(['./WebComponents/src/**','!./**/webpart{,/**}'])  // '!./**/css{,/**}','!./**/js{,/**}','!./**/images{,/**}',
        .pipe(gulp.dest('./WebComponents/buildSP/'));
});
...
gulp.task('buildhtmlPartLoader', function () {
    return gulp.src(['./WebComponents/.container/localtop.htm',
        ...
        .pipe(concat('webpartcontent.html'))
        .pipe(gulp.dest('./WebComponents/buildlocal/SBFrameWork/MyNewPart/webpart'));
});
...
gulp.task('buildTheRest', function () {
    return gulp.src(['./WebComponents/src/**',  '!./**/webpartcontent.htm'])  //'!./**/js{,/**}','!./**/css{,/**}',
        .pipe(gulp.dest('./WebComponents/buildlocal/SBFrameWork/MyNewPart'));
});
